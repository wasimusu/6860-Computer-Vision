...
imshow(edgeImage);disp("I determined the threhosld by computing the histogram of the image and selecting the value which clearly divides the histogram into two parts - black and white");
disp("This is also known as Ostu's algorithm which is used to find thresholds in image");
pause
% %-----Finish Solving Problem II-1 -----%

image = imread('rice.jpg');
CalEdgeHist(image, 10);
pause;
close all;